...
public class RecipeController {
    ...
    public ResponseEntity<List<RecipeResponse>> getUserRecipe(@PathVariable UUID userId, @RequestParam(name = "name") String recipeName) {
    ...
    public ResponseEntity<String> saveRecipeFromUser(@PathVariable UUID userId, @PathVariable long recipeId) {
